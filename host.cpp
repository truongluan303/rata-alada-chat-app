...
int main(int argc, char *argv[])
{
    ...
    struct timeval start1, end1;        // keep track of the session time
    gettimeofday(&start1, NULL);
    int bytes_read, bytes_written = 0;    // keep track of the size of data sent
    ...
    while(true)
    {
        ...
        if(data == "exit")
        {
            ...
            send(new_socket_desc, (char*)&msg, strlen(msg), 0);
            break;
        }
    ...
    cout << "Elapsed time: " << (end1.tv_sec - start1.tv_sec) << " s" << endl;
